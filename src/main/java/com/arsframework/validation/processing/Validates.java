...
public abstract class Validates {
    ...
    public static boolean isType(Symbol.ClassSymbol symbol, Class<?>... types) {
        ...
        return superclass == null || superclass.tsym == null ? false : isType((Symbol.ClassSymbol) superclass.tsym,
                types);
    }
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildFormatExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                            String pattern) {
        // 构建条件判断依据
        ...
        // 格式校验条件表达式
        return basis == null ? null : merge(maker, JCTree.Tag.AND, buildNonnullExpression(maker, names, param),
                maker.Unary(
                        JCTree.Tag.NOT,
                        maker.Apply(
                                List.nil(),
    ...
    public static JCTree.JCExpression buildNumberCompareExpression(TreeMaker maker, Names names,
        ...
        if (isNumber((Symbol.ClassSymbol) param.type.tsym)) { // 数字
            return maker.Binary(tag, maker.Ident(names.fromString(param.name.toString())), maker.Literal(TypeTag.LONG
                    , value));
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildIsExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        long value) {
        JCTree.JCExpression expression = buildNumberCompareExpression(maker, names, param, JCTree.Tag.NE, value);
        return expression == null ? null : merge(maker, JCTree.Tag.AND, buildNonnullExpression(maker, names, param),
                expression);
    }
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildNotExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                         long value) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildMaxExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                         long max) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildMinExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                         long min) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildSizeExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                          long min, long max) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildOptionExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                            long[] options) {
        JCTree.JCExpression expression;
        if (options.length == 0 || (expression = buildNumberCompareExpression(maker, names, param, JCTree.Tag.NE,
                options[0])) == null) {
            return null;
    ...
    public static JCTree.JCExpression buildCompareExpression(TreeMaker maker, Names names,
        ...
        if (numeric || ((tag == JCTree.Tag.EQ || tag == JCTree.Tag.NE)
            ...
            expression = maker.Binary(tag, maker.Ident(names.fromString(param.name.toString())),
            ...
            if (tag == JCTree.Tag.GT) {
                ...
                expression = maker.Binary(JCTree.Tag.AND, maker.Unary(JCTree.Tag.NOT,
                        maker.Ident(names.fromString(param.name.toString()))),
                        maker.Ident(names.fromString(arg))
                );
            } else {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildGtExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildGeExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildLtExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildLeExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildEqExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildNeExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                        String arg) {
     ...
     * @return 语法树参数验证表达式对象
     */
    public static JCTree.JCExpression buildBoolExpression(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                          boolean bool) {
    ...
    public static JCTree.JCIf buildValidateException(TreeMaker maker, Names names, Symbol.VarSymbol param,
                                                     JCTree.JCExpression condition, String exception, String message,
                                                     Object... args) {
        if (condition == null) {
            return null;
        }
        ...
        return maker.If(condition, maker.Throw(buildClassExpression(maker, names, exception, String.format(message,
                args))), null);
    }
}
